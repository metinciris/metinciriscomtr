...
import { Calendar, ExternalLink, Tag, Github as GithubIcon } from 'lucide-react';
        ...
        <PageContainer>
            ...
            <div className="bg-gradient-to-r from-[#333333] to-[#24292e] text-white p-12 mb-8 rounded-xl shadow-lg">
                <div className="flex items-center gap-4 mb-4">
                    <GithubIcon size={48} />
                    <h1 className="text-white text-4xl font-bold">GitHub</h1>
                </div>
                <p className="text-white/90 max-w-3xl text-lg">
                    Açık kaynak projelerim, kod örnekleri ve teknik paylaşımlarım.
                </p>
                <a
                    href="https://github.com/metinciris"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 mt-4 bg-white text-[#333333] px-6 py-3 rounded-lg hover:bg-white/90 transition-colors font-medium"
                >
                    <GithubIcon size={20} />
