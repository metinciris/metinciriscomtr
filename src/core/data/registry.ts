...
export const PAGE_REGISTRY: Record<string, PageMetadata> = {
    ...
    'prostat-igne-biyopsi': {
        slug: 'prostat-igne-biyopsi',
        title: 'Prostat İğne Biyopsi Raporlama | Prof Dr Metin Çiriş',
        description: 'Kor bazlı prostat iğne biyopsi sinoptik raporlama motoru — Gleason/Grade Group, kor tutulum haritası.',
        keywords: 'prostat biyopsi, gleason skoru, grade grup, prostat karsinomu, kor haritası, patoloji raporu',
        noindex: true,
        lastmod: '2026-07-31',
        priority: 0.8,
        changefreq: 'monthly',
        navLabel: 'Prostat İğne Biyopsi',
        navGroup: 'raporlama',
        load: () => import('@/pages/ProstatIgneBiyopsi').then(m => ({ default: m.ProstatIgneBiyopsi as unknown as React.ComponentType<Record<string, unknown>> })),
    },
    'dunya-saatleri': {
        slug: 'dunya-saatleri',
