...
export const EndoskopiLayout: React.FC<LayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <main className="max-w-[1600px] mx-auto px-2 py-6 sm:px-4 lg:px-6">
        {children}
      </main>
      <footer className="bg-white border-t border-gray-200 mt-12">
        <div className="max-w-[1600px] mx-auto px-4 py-4 sm:px-6 lg:px-8 text-center text-gray-500 text-sm">
